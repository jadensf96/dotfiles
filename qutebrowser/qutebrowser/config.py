...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/fish/.config/qutebrowser/userscripts/*')
...
# Default zoom level for web pages (100% = 1.0, 125% = 1.25, etc.)
# Type: Percentage
